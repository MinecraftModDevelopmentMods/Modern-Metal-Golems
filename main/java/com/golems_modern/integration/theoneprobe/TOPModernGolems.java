package com.golems_modern.integration.theoneprobe;
...
public class TOPModernGolems extends ModernGolemDescriptionManager implements IProbeInfoEntityProvider  
{	
	public TOPModernGolems()
	{
		super();
	...
	{		
		...
		{
			IProbeInfoEntityProvider instance = new TOPModernGolems();
